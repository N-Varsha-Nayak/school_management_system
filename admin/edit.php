...
if ($user['type'] == 'student') {
    ...
    $details_query = mysqli_query($db_conn, "SELECT * FROM teachers WHERE account_id = $id");
    $details = mysqli_fetch_assoc($details_query);
}

// Update functionality: If form is submitted, update both accounts and the respective table
if (isset($_POST['update'])) {
    ...
    if ($user['type'] == 'student') {
        ...
        mysqli_query($db_conn, "UPDATE teachers SET qualification = '$qualification', department = '$department', 
                                experience = '$experience' WHERE account_id = $id");
    }
    ...
    <form method="POST">
        ...
        <?php if ($user['type'] == 'teacher') { ?>
            <div class="form-group">
                ...
                <input type="text" class="form-control" name="qualification" value="<?php echo $details['qualification']; ?>" required>
            </div>
            <div class="form-group">
                <label>Department</label>
                <input type="text" class="form-control" name="department" value="<?php echo $details['department']; ?>" required>
            </div>
            <div class="form-group">
                <label>Experience</label>
                <input type="number" class="form-control" name="experience" value="<?php echo $details['experience']; ?>" required>
            </div>
            <!-- Add other fields for teacher -->
        <?php } ?>
