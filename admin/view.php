        ...
        <div class="card">
            <div class="card-body">
                ...
                <?php } elseif ($user['type'] == 'teacher') { ?>
                    ...
                    <input type="text" name="qualification" value="<?php echo $details['qualification']; ?>" class="form-control" required>

                    <label for="department">Department:</label>
                    <input type="text" name="department" value="<?php echo $details['department']; ?>" class="form-control" required>

                    <label for="experience">Experience:</label>
                    <input type="number" name="experience" value="<?php echo $details['experience']; ?>" class="form-control" required>
                <?php } ?>
